...
export default function Navbar() {
	...
	return (
		<div className={`${open ? "min-w-60" : "min-w-11"} h-auto min-h-screen bg-neutral-700 w-min`}>
			<div className="w-full h-11 p-2 flex flex-row gap-2 bg-neutral-800 items-center">
